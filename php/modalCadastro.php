          ...
          <div class="row">
            <div class="col">
              <div class="form-group mx-0">
                ...
                <input type="text" class="form-control required" id="telefone" name="telefone" placeholder="(00) 0 0000-0000" autocomplete="off"  required onchange="telValidate()"/>
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group mx-0">
                ...
                <input type="password" class="form-control required" id="pass" name="senha"placeholder="Crie uma senha" autocomplete="off" required/>
            ...
            <div class="col-6">
              <div class="form-group mx-0">
                ...
                <input type="password" class="form-control required" id="confpass" name="confsenha"placeholder="Confirme dua senha" autocomplete="off" required/>
